...
urlpatterns = [
    ...
    path('clients/export/', client_export, name='client_export'),
    path('clients/new/', client_create, name='client_create'),
    path('clients/reverse-geocode/', client_reverse_geocode, name='client_reverse_geocode'),
