...
from apps.core.models import CompanySettings, AuditLog
from apps.inventory.models import Category, Brand, Unit, Product, Client, Supplier
...
if __name__ == '__main__':
    ...
    admin, _ = User.objects.get_or_create(username='admin', defaults={'email': 'admin@elamine.dz', 'role': User.ADMIN, 'is_superuser': True, 'is_staff': True})
    ...
    Product.objects.get_or_create(reference='PRD001', defaults={
        'barcode': '1234567890123', 'name': 'Farine 1kg', 'category': c1, 'brand': b1, 'unit': u1,
        'purchase_price': 120.00, 'sale_price': 150.00, 'quantity': 40, 'minimum_stock': 10,
    })
